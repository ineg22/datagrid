  ...
  return (
    <>
      ...
      <button className="SortButton" onClick={sortHandle}>
        <span
          className={
            sortedUp ? 'sortLabel sortUp sortActive' : 'sortLabel sortUp'
          }
        >
        ...
        <span
          className={
            sortedDown ? 'sortLabel sortDown sortActive' : 'sortLabel sortDown'
          }
        >
          <svg viewBox="0 0 1024 1024" fill="currentColor">
      ...
      <span className="currentSortPlace">
        {currentSortPlace ? currentSortPlace : null}
      </span>
    </>
  );
};
